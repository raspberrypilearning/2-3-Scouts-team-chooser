...
3. Add a `repeat until` block to the bottom of your code. Then add the blocks below to the inside of it. You can find the blocks in the **variables** and **operators** menus.

4. Test your code, when you click the green flag, enter a number and enter some names, you should see the list randomly shuffle on the stage!
